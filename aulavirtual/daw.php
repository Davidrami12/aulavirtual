            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6 col-md-9 col-sm-12">
                    <div class="p-3 bg-light">
                        ...
                        <p>Desarrollar, implantar, y mantener aplicaciones web, con independencia del modelo empleado y utilizando tecnologías 
                            específicas, garantizando el acceso a los datos de forma segura y cumpliendo los criterios de accesibilidad, 
                            usabilidad y calidad exigidas por los estándares establecidos.
                        </p>
                        <hr>
                        <h1>1º CURSO</h1>
                        <table id="tabla">
                        ...
                        <table id="tabla">
                            ...
                            <tr>
                                <td id="nombre">Diseño de interfaces web</td>
                                <td>115 h</td>
                                <td>6</td>
                            </tr>
                            <tr>

            ...
            <div class="row gx-5">
                <div class="col-lg-3 col-md-2 col-sm-12"></div>
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <form action="crear-post.php" method="POST" id="formulario" enctype="multipart/form-data">
                            <div class="p-3 mb-2 bg-light text-dark" id="contenido">
                                <br>
                                <div>
                                    <label for="titulo"><b>Título del post:</b></label>
                                    <input type="text" id="titulo" name="titulo" required>
                                </div>
                                <div>
                                    <label for="tema"><b>Tema para el post</b></label>
                                    <select name="id_tema">
                                        <?php
                                ...
                                <div class="button">
                                    <button type="submit" class="btn btn-outline-dark" id="crear"><i class="fas fa-paste"></i>&nbsp;&nbsp;Crear post</button>
                                </div>
                                <br>
                            </div>
                        </form>

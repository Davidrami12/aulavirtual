...
<html lang="en">
    <head>
        ...
        <title>Profesor - Creando tarea</title>
        <!-- Favicon-->
        ...
        <div class="container-fluid">
            <div class="row gx-5">
                ...
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <form action="crear-tema.php" method="POST" id="formulario">
                        <div class="p-3 bg-light text-dark" id="contenido">
                            <br>
                            <div>
                                <label for="titulo"><b>Título del tema:</b></label>
                                <input type="text" id="titulo" name="titulo" required>
                            </div>
                            <br>
                            <div>
                                <label for="descripcion"><b>Descripción del tema</b></label>
                                <textarea id="descripcion" name="descripcion" rows="5" cols="50" required></textarea>
                            </div>
                            <br><br>
                            <div class="button">
                                <button type="submit" class="btn btn-outline-dark" id="crear"><i class="far fa-newspaper"></i>&nbsp;&nbsp;Crear tema</button>
                            </div>
                            <br>
                        </div>
                    </form>

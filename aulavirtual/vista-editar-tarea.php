...
<html lang="en">
    <head>
        ...
        <title>Profesor - Editando tarea</title>
        <!-- Favicon-->
        ...
        <div class="container-fluid">
            <div class="row gx-5">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <form action="editar-tarea.php" method="POST" id="formulario">
                        <div class="p-3 mb-2 bg-light text-dark" id="contenido">
                            ...
                            <div>
                                ...
                                <textarea id="descripcion" name="descripcion" rows="5" cols="50"><?php echo $descripcion;?></textarea>
                            </div>
                            <div>
                            ...
                            <div class="button">
                                <button type="submit" class="btn btn-outline-dark" id="crear"><i class="fas fa-pencil-alt"></i>&nbsp;&nbsp;Editar tarea</button>
                            </div>
                        </div>
                    </form>
                </div>

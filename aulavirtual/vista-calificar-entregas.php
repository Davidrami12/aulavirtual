...
<html lang="en">
    <head>
        ...
        <title>Profesor - Calificando tareas</title>
        <!-- Favicon-->
        ...
        <div class="container-fluid">
            <div class="row gx-5">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 ">
                    <form action="calificar.php" method="POST" id="formulario">
                        <div class="p-3 mb-2 bg-light text-dark" id="contenido">
                            <br>
                            <input type="hidden" id="id" name="id" value="<?php echo $_GET["id"];?>" required> <!--arrastrar id de la tarea-->
                            <div>
                                <label for="nota"><b>Nota:</b></label>
                                <input type="number" id="nota" name="nota" required>
                            </div>
                            <div>
                                <label for="anotacion"><b>Anotación</b></label>
                                <textarea id="anotacion" name="anotacion" rows="5" cols="50" required></textarea>
                            </div>
                            <div class="button">
                                <button type="submit" class="btn btn-outline-dark" id="calificarEntrega">Calificar entrega</button>
                            </div>
                        </div>
                    </form>
                </div>
